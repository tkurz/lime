...
(function() {
  ...
  window.TVPlugin = (function(_super) {
    ...
    TVPlugin.prototype.renderActor = function(annotation, fullEntity, container) {
      var awardsItem, awardsList, awardsListArray, comment, label, lime, modalContent, page, result, starringItem, starringList, starringListArray, _i, _j, _len, _len1;
      ...
      if (awardsListArray) {
        for (_j = 0, _len1 = awardsListArray.length; _j < _len1; _j++) {
          ...
          if (awardsItem.indexOf("winners") || awardsItem.indexOf("award") || awardsItem.indexOf("awards")) {
