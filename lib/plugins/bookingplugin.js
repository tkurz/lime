  ...
  window.BookingPlugin = (function(_super) {
    ...
    BookingPlugin.prototype.handleAnnotation = function(annotation) {
      ...
      $.getJSON("http://smart-ip.net/geoip-json?callback=?", function(data) {
        _this.clientIP = data.host;
        return console.log(_this.clientIP);
      });
    ...
    BookingPlugin.prototype.expandWidget = function(annotation, outputElement) {
      var businessData, lime, modalContent, resource, result,
        _this = this;
      ...
      if (businessData.length) {
        if (businessData.length > 0) {
          ...
          $(".businessContact").click(function() {
            var bemail, bname, entry, grdata, time;
