...
(function() {
    ...
    */
    ...
    function LIMEPlayer(opts) {
      ...
      if (typeof this.options.containerDiv === "string") {
        this.el = $("#" + this.options.containerDiv);
      } else {
        this.el = $(this.options.containerDiv);
      }
      if (this.el.length !== 1) {
    ...
    LIMEPlayer.prototype._initVideoPlayer = function(cb) {
      ...
      return window.LIMEPlayer.VideoPlayerInit(this.videoEl[0], {}, function(err, playerInstance) {
        ...
        _this.fullscreenWidgetContainer = $("<div class='fullscreen-annotation-wrapper'></div>");
    ...
    LIMEPlayer.prototype._initEventListeners = function() {
      var _this = this;
      $(this.player).bind('timeupdate', function(playerEvent) {
        var e;
        e = $.Event("timeupdate", {
      ...
      $(this.player).bind('fullscreenchange', function(e) {
    ...
    LIMEPlayer.prototype.updateWidgetsList = _.throttle(function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        container = _ref[_i];
        if (!$(container).data().sorted) {
          widgetsEls = $(container).find('.lime-widget');
          widgetsSorted = _.sortBy(this.widgets, function(widgetEl) {
            var _ref1;
            return (_ref1 = $(widgetEl).data().widget) != null ? _ref1.options.sortBy() : void 0;
          });
        ...
        if (this.options.widgetVisibility === 'scrolling-list') {
          first = _.detect($(container.element).children(), function(widgetElement) {
            var widget;
          ...
          if (first) {
            ...
            _results.push($(first).addClass('nav-selected'));
          } else {
            _results.push(void 0);
          }
        } else {
          _results.push((function() {
            ...
            _ref1 = $(container.element).children();
            _results1 = [];
    ...
    LIMEPlayer.prototype.initKeyEventsHandlers = function() {
      ...
      $(window).keydown(function(e) {
        ...
        if (_this.activeWidget) {
          ...
          if (event) {
            $(_this.activeWidget).trigger(event);
          }
          $(_this.activeWidget).trigger(e);
          if (e.keyCode === 27) {
            if ((_ref = _this.modalContainer) != null ? _ref.is(':visible') : void 0) {
              if (history.pushState) {
                return history.back();
              } else {
                return _this.modalContainer.trigger($.Event('close'));
              }
            }
          }
        }
      ...
      $(this).bind('downarrow', function(e) {
      ...
      $(this).bind('playpause', function(e) {
      ...
      $(this).bind('rightarrow', function(e) {
        ...
        return $(_this.player).trigger('timeupdate');
      });
      return $(this).bind('leftarrow', function(e) {
  ...
  window.LimePlugin = (function() {
    ...
    LimePlugin.prototype.getModalContainer = function() {
      ...
      if (!modalContainer) {
        ...
        modalContainer = this.lime.modalContainer;
        mask = this.lime.modalMask;
        $(modalContainer).bind('close', function(e) {
          mask.hide();
          modalContainer.hide();
  ...
  window.AnnotationOverlays = (function(_super) {
    ...
    AnnotationOverlays.prototype.initSpacialAnnotations = function() {
      var annotation, container, limeplayer, resize, _i, _len, _ref,
        _this = this;
      ...
      resize = function() {
        ...
        videoEl = $('video', _this.lime.element);
      ...
      if (annotation.isBookmark()) {
        ...
        return recursiveFetch(entityUri, this.options.followRedirects, 2, function(res) {
          ...
          annotation.getStarring = function() {
            ...
            starringList = this._detectProperty(this.entities, 'dbpedia-owl:birthDate');
            if (!starringList) {
              _ref = this.entities;
              for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                entity = _ref[_i];
