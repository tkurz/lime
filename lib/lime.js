    ...
    */
    ...
    LIMEPlayer.prototype.initKeyEventsHandlers = function() {
      ...
      $(this).bind('rightarrow', function(e) {
        ...
        return _this.player.seek(firstFutureAnnotation.start);
      });
      return $(this).bind('leftarrow', function(e) {
        ...
        if (pastAnnotations.length) {
          ...
          return _this.player.seek(latestPastAnnotation.start);
        } else {
          return _this.player.seek(0);
        }
      });
    };
    ...
    LIMEPlayer.prototype._moveWidgets = function(isFullscreen) {
      ...
      for (_m = 0, _len4 = _ref4.length; _m < _len4; _m++) {
        ...
        if (annotation.state === 'active') {
          $(annotation).trigger($.Event("becomeInactive", {
            annotation: annotation
          }));
          $(annotation).trigger($.Event("becomeActive", {
            annotation: annotation
