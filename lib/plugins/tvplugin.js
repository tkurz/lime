...
(function() {
  ...
  window.TVPlugin = (function(_super) {
    ...
    TVPlugin.prototype.renderCharacter = function(annotation, fullEntity, container) {
      var comment, firstAppearance, label, modalContent, nationality, nick, nickname, nicknameList, occupation, page, portrayer, result, _i, _len;
      modalContent = jQuery(container);
      modalContent.css("width", "450px");
      modalContent.css("height", "auto");
      console.log(fullEntity);
    ...
    TVPlugin.prototype._initWidget = function(annotation, fullEntity, widgetType, renderMethod, widgetOptions) {
      ...
      jQuery(widget).bind('activate', function(e) {
        return renderMethod.apply(_this, [annotation, fullEntity, _this.getModalContainer()]);
      });
