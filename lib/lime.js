...
(function() {
  ...
  window.Annotation = (function() {
    function Annotation(hash) {
      ...
      this._prefLabel = this.hash.prefLabel.value;
...
(function() {
  ...
  window.GeoNamesMapPlugin = (function(_super) {
    ...
    GeoNamesMapPlugin.prototype.init = function() {
      var annotation, relevant, _i, _len, _ref1, _ref2, _results;
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        annotation = _ref1[_i];
        relevant = false;
        relevant = annotation.resource.value.indexOf("sws.geonames.org") > 0 || (annotation.hash.latitude && annotation.hash.latitude);
        if ((_ref2 = annotation.relation.value) !== 'http://connectme.at/ontology#explicitlyShows' && _ref2 !== 'http://connectme.at/ontology#explicitlyMentions' && _ref2 !== 'http://connectme.at/ontology#implicitlyShows' && _ref2 !== 'http://connectme.at/ontology#implicitlyMentions') {
          relevant = false;
        }
        if (relevant) {
          _results.push(this.handleAnnotation(annotation));
