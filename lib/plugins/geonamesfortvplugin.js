  ...
  window.GeoNamesMapForTVPlugin = (function(_super) {
    ...
    GeoNamesMapForTVPlugin.prototype.showInModalWindow = function(annotation, outputElement) {
      ...
      $("#geoMap").click(function() {
        ...
        map = "#map_area";
        jQuery(map).empty();
        newmap = "<img src=\"http://maps.google.com/maps/api/staticmap?center=" + latitude + "," + longitude + "&zoom=" + _this.mapzoom + "&size=600x500&maptype=roadmap&visual_refresh=true&sensor=false\"></img>";
      ...
      $("#geoRout").click(function() {
        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition((function(position) {
            var i, latitude, locationName, longitude, map, myOptions, newmap, output;
            i = void 0;
            latitude = void 0;
            locationName = void 0;
            longitude = void 0;
            ...
            map = "#map_area";
            jQuery(map).empty();
            newmap = "<img src=\"http://maps.google.com/maps/api/staticmap?path=color:0x0000ff|weight:5|" + position.coords.latitude + "," + position.coords.longitude + "|" + latitude + "," + longitude + "&zoom=" + this.routemapzoom + "&size=600x500&visual_refresh=true&maptype=roadmap&sensor=false\"></img>";
