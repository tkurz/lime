...
(function() {
  ...
  window.UserSettingsPlugin = (function(_super) {
    ...
    UserSettingsPlugin.prototype.renderUserSettingsInModalWindow = function() {
      ...
      return this.attachFormEventHandlers();
    };

    UserSettingsPlugin.prototype.attachFormEventHandlers = function() {
      var _this = this;
      return $(".informationwidgets.setting").click(function(e) {
        _this.DBPediaInfoPluginID = _this.lime.options.plugins["DBPediaInfoPlugin"];
        return console.log(_this.DBPediaInfoPluginID.toString());
      });
    };
