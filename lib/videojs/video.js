...
Version 3.2.0
LGPL v3 LICENSE INFO - This file is part of Video.js. Copyright 2011 Zencoder, Inc.
Video.js is free software: you can redistribute it and/or modify it under the terms of the GNU Lesser General Public License as published by the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.
Video.js is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU Lesser General Public License for more details. You should have received a copy of the GNU Lesser General Public License along with Video.js.  If not, see <http://www.gnu.org/licenses/>.
*/
...
VideoJS.options = {
  ...
  components: {
    //"Spatialannot": {},			//added by SORIN - this should be removed later down the road
	"posterImage": {},	
    "textTrackDisplay": {},
    "loadingSpinner": {},
    "bigPlayButton": {},
...
_V_.PosterImage = _V_.Button.extend({
  init: function(player, options){
    ...
    player.addEvent("play", _V_.proxy(this, this.hide));
	//player.addEvent("ended", _V_.proxy(this, this.show)); //SORIN - for some reason it overlaps 2 of the 4 annotation regions why??? z-index seems fine
  },
...
_V_.html5 = _V_.PlaybackTech.extend({
  ...
  init: function(player, options, ready){
	...
	var eventaction = (ua.match(/iPad/i)) ? "touchstart" : "click";
    this.addEvent(eventaction, this.proxy(this.onClick));
