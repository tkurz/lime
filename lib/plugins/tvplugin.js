...
(function() {
  ...
  window.TVPlugin = (function(_super) {
    ...
    TVPlugin.prototype.renderActor = function(annotation, container) {
      var awardsItem, awardsList, awardsListArray, birthDate, birthPlace, comment, label, lime, modalContent, page, result, starringList, starringListArray, startTime, _i, _len,
        _this = this;
      ...
      birthDate = "";
      try {
        if (annotation._detectProperty('dbprop:birthDate' !== void 0)) {
          birthDate += 'Birth date: ' + annotation._detectProperty('dbprop:birthDate' + '<br>');
        }
      } catch (error) {
        try {
          if (annotation._detectProperty('dbprop:dateOfBirth' !== void 0)) {
      ...
      birthPlace = "";
      try {
        if (annotation._detectProperty('dbprop:birthPlace')['@value'] !== void 0) {
          birthPlace += 'Birth place: ' + annotation._detectProperty('dbprop:birthPlace')['@value'] + '<br>';
        }
      } catch (error) {
        try {
          if (annotation._detectProperty('dbprop:placeOfBirth')['@value'] !== void 0) {
    ...
    TVPlugin.prototype.renderDirector = function(annotation, container) {
      var awardsItem, awardsList, awardsListArray, birthDate, birthPlace, comment, label, lime, modalContent, page, result, starringItem, starringList, starringListArray, startTime, _i, _j, _len, _len1,
        _this = this;
      modalContent = jQuery(container);
      modalContent.css("width", "450px");
      modalContent.css("height", "auto");
