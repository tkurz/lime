      ...
      $("#geoRout").click(function() {
        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition((function(position) {
            var i, latitude, locationName, longitude, map, mapzoom, myOptions, output;
            i = void 0;
            latitude = void 0;
            locationName = void 0;
            longitude = void 0;
            ...
            mapzoom = 6;
            map = "#map_area";
            return jQuery(map).attr("src", "http://maps.google.com/maps/api/staticmap?path=color:0x0000ff|weight:5|" + position.coords.latitude + "," + position.coords.longitude + "|" + latitude + "," + longitude + "&zoom=" + mapzoom + "&size=600x500&maptype=roadmap&sensor=false");
            /*
