...
(function() {
  ...
  window.HelpPlugin = (function(_super) {
    ...
    HelpPlugin.prototype.renderStatisticsInModalWindow = function() {
      var modalContent, result;
      result = "<div class=\"statistic\" style=\"margin:0 auto\" ><iframe style=\"height: 95%; width: 100%; position: relative; margin: 0 auto; \" src=\"/resources/help.html\"><p>Your browser does not support iframes.</p></iframe></div>";
