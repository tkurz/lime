        ...
        return this.recursiveFetch(entityUri, this.options.followRedirects, 2, function(res) {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            annotation.getDepiction = function(options) {
              var depiction, entity, result, singleDepiction, _j, _len1, _ref1;
              _ref1 = this.entities;
              for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
                entity = _ref1[_j];
                result = "";
            ...
            annotation.getPage = function() {
              var entity, homepage, label, value, _j, _len1, _ref1;
            ...
            annotation.getType = function() {
              var entity, result, typeSet, _j, _len1, _ref1;
              _ref1 = this.entities;
              for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
                entity = _ref1[_j];
            ...
            annotation.getStarring = function() {
              var entity, starringList, value, _j, _len1, _ref1;
