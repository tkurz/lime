...
(function() {
  ...
  window.LSIImagePlugin = (function(_super) {
    ...
    LSIImagePlugin.prototype.showDepictionInModalWindow = function(annotation) {
      var lodResource;
    var term = annotation.resource.value;
	  var limit = 9;
      var offset = 0;
	  var z = new VIE();
        z.use(new z.StanbolService({
           ...
           // enhancerUrlPostfix: "/enhancer/chain/austrian-national-library",
            entityhubSite: "oocaboo",
            proxyDisabled: true
        }));
	  z.find({term: term, limit: limit, offset: offset}).using('stanbol').execute().done(function(entities) {
    ...
    LSIImagePlugin.prototype.displayModal = function(annotation) {
      ...
      return this.showDepictionInModalWindow(annotation);
    };
