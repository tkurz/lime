  ...
  window.LIMEPlayer = (function() {
    ...
    */
    ...
    LIMEPlayer.prototype._initVideoPlayer = function(cb) {
      ...
      this.el.append("<div class='videowrapper' id='videowrapper'>\n  <video class='video-js vjs-default-skin' controls preload='metadata' width='" + this.options.videoPlayerSize["width"] + "' height='" + this.options.videoPlayerSize["height"] + "' poster='img/connectme-video-poster.jpg'>\n    " + displaysrc + "\n  </video>\n</div>");
