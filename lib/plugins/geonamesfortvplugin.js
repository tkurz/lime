      ...
      jQuery("#geoRout").click(function() {
        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition((function(position) {
            var destination, i, latitude, locationName, longitude, map, myOptions, newmap, output, request, start;
            i = void 0;
            latitude = void 0;
            locationName = void 0;
            longitude = void 0;
            ...
            map = "#map_area";
            jQuery(map).empty();
            newmap = "<img src=\"http://maps.google.com/maps/api/staticmap?markers=" + position.coords.latitude + "," + position.coords.longitude + ",greena|" + latitude + "," + longitude + ",greenb&path=color:0x0000ff|weight:5|" + position.coords.latitude + "," + position.coords.longitude + "|" + latitude + "," + longitude + "&zoom=" + this.routemapzoom + "&size=450x450&visual_refresh=true&maptype=roadmap&sensor=false\"></img>";
            jQuery(map).append(newmap);
            ...
            directionsService.route(request, function(result, status) {
              var myRoute;
              return directionsDisplay.setDirections(result((function() {
            ...
            return console.log("@directionString= ", this.directionString);
          }), function(error) {
            switch (error.code) {
              case error.TIMEOUT:
