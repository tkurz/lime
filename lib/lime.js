...
(function() {
  ...
  window.AnnotationOverlays = (function(_super) {
    ...
    AnnotationOverlays.prototype.renderConceptOverlay = function(annotation) {
      ...
      res = jQuery("<ul class=\"navlist\">" + res + "</ul>");
          ...
          success: function(res) {
            ...
            if (_.keys(res).length) {
              ...
              annotation.getLabel = function() {
                var label, props;
                props = this.entity[this.resource.value];
                label = _(props['http://www.w3.org/2000/01/rdf-schema#label']).detect(function(labelObj) {
                  return labelObj.lang === lime.options.preferredLanguage;
                }).value;
                return label;
              };
              annotation.getDescription = function() {};
              annotation.getDepiction = function() {
                var depiction, props, _ref;
                props = this.entity[this.resource.value];
                depiction = (_ref = props['http://xmlns.com/foaf/0.1/depiction']) != null ? _ref[0].value : void 0;
                return depiction;
              };
              return annotation.getPage = function() {
                var page, props, _ref;
                props = this.entity[this.resource.value];
                page = (_ref = props['http://xmlns.com/foaf/0.1/page']) != null ? _ref[0].value : void 0;
                return page;
              };
            }
          }
