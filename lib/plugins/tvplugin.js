...
(function() {
  ...
  window.TVPlugin = (function(_super) {
    ...
    TVPlugin.prototype.renderActor = function(annotation, fullEntity, container) {
      ...
      starringListArray = [];
      starringList = "";
      starringListArray = this._getStarringList(annotation, function(data, result) {
        var show, _i, _len, _ref;
        result = [];
    ...
    TVPlugin.prototype._getStarringList = function(annotation, callback) {
