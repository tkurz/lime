...
(function() {
  ...
  window.LIMEPlayer = (function() {
    ...
    LIMEPlayer.prototype._initVideoPlayer = function(cb) {
      ...
      return window.LIMEPlayer.VideoJSInit('video_player', {}, function(err, playerInstance) {
        if (err) {
          alert(err);
          return;
        }
  ...
  window.LIMEPlayer.VideoJSInit = function(el, options, cb) {
    var _this = this;
    if (!_V_) {
  ...
  window.AnnotationOverlays = (function(_super) {
    ...
    AnnotationOverlays.prototype.renderConceptOverlay = function(annotation) {
      ...
      for (_i = 0, _len = activeAnnotations.length; _i < _len; _i++) {
        ...
        depiction = typeof ann.getDepiction === "function" ? ann.getDepiction() : void 0;
    ...
    LDPlugin.prototype.loadAnnotation = function(annotation) {
      ...
      recursiveFetch(entityUri, this.options.followRedirects, 2, function(res) {
        ...
        annotation.getPage = function() {
          var entity, label, value, _i, _len, _ref;
          this._detectProperty(this.entities, 'foaf:homepage');
          _ref = this.entities;
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            entity = _ref[_i];
