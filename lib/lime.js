    ...
    BookingPlugin.prototype.expandWidget = function(annotation, outputElement) {
      ...
      if (businessData.length) {
        if (businessData.length > 0) {
          ...
          $(".businessContact").click(function() {
            ...
            if (grdata.length) {
              if (grdata.length > 0) {
                ...
                bname = grdata[0].name;
                return $.post('http://devserver.sti2.org/connectme/logger.php?', {
          ...
          return $("#businessWho").trigger("click");
        }
      }
    };
...
(function() {
  ...
  window.TVPlugin = (function(_super) {
    ...
    TVPlugin.prototype.renderActor = function(annotation, container) {
      var awardsItem, awardsList, awardsListArray, birthDate, birthPlace, comment, error, label, lime, modalContent, page, result, starringList, starringListArray, _i, _len,
        _this = this;
      modalContent = jQuery(container);
    ...
    TVPlugin.prototype.renderCharacter = function(annotation, container) {
      var comment, error, firstAppearance, label, modalContent, nationality, nick, nickname, nicknameList, occupation, page, portrayer, result, _i, _len;
      modalContent = jQuery(container);
      modalContent.css("width", "450px");
      modalContent.css("height", "auto");
      label = annotation.getLabel();
    ...
    TVPlugin.prototype.renderDirector = function(annotation, container) {
      var awardsItem, awardsList, awardsListArray, birthDate, birthPlace, comment, error, label, lime, modalContent, page, result, starringItem, starringList, starringListArray, _i, _j, _len, _len1;
      modalContent = jQuery(container);
      modalContent.css("width", "450px");
      modalContent.css("height", "auto");
      label = annotation.getLabel();
