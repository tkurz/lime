  ...
  window.GeoNamesMapForTVPlugin = (function(_super) {
    ...
    GeoNamesMapForTVPlugin.prototype.handleAnnotation = function(annotation) {
      ...
      return annotation.entityPromise.done(function() {
        ...
        jQuery(widget).bind("uparrow", function(e) {
          _this.mapzoom++;
          _this.routemapzoom++;
          return jQuery(".selected").trigger("click");
        });
    ...
    GeoNamesMapForTVPlugin.prototype.showInModalWindow = function(annotation, outputElement) {
      ...
      $("#geoMap").click(function() {
        var i, latitude, latlng, locationName, longitude, map, myOptions, output;
        ...
        _this.mapzoom = 12;
        map = "#map_area";
        jQuery(map).attr("src", "http://maps.google.com/maps/api/staticmap?center=" + latitude + "," + longitude + "&zoom=" + _this.mapzoom + "&size=600x500&maptype=roadmap&sensor=false");
      ...
      $("#geoRout").click(function() {
        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition((function(position) {
            var i, latitude, locationName, longitude, map, myOptions, output;
            i = void 0;
            latitude = void 0;
            locationName = void 0;
            longitude = void 0;
            ...
            this.routemapzoom = 6;
            map = "#map_area";
            return jQuery(map).attr("src", "http://maps.google.com/maps/api/staticmap?path=color:0x0000ff|weight:5|" + position.coords.latitude + "," + position.coords.longitude + "|" + latitude + "," + longitude + "&zoom=" + this.routemapzoom + "&size=600x500&maptype=roadmap&sensor=false");
            /*
