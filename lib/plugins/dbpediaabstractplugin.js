...
(function() {
	...
	window.DBPediaAbstractPlugin = (function(_super) {
		...
		DBPediaAbstractPlugin.prototype.renderAnnotation = function(annotation) {
			var label = annotation.getLabel();
            var page = annotation.getPage();
            var lime = this.lime;
            var comment = _(annotation.entity['http://dbpedia.org/ontology/abstract']).detect(function(abstractObj) {
                return abstractObj["@language"] === lime.options.preferredLanguage;
            })["@value"];
