    ...
    TestPlugin.prototype.init = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        jQuery(annotation).bind('becomeActive', function(e) {
          ...
          if (domEl) {
            ...
            if (e.target.ldLoaded) {
              domEl.html(_this.renderAnnotation(e.target));
            } else {
              jQuery(e.target).bind('ldloaded', function(e2) {
                return domEl.html(_this.renderAnnotation(e2.target));
              });
            }
            return e.target.widgets.TestPlugin = domEl;
          } else {
        ...
        _results.push(jQuery(annotation).bind("becomeInactive", function(e) {
          ...
          if (e.target.widgets) {
            return delete e.target.widgets.TestPlugin;
          } else {
            debugger;
          }
        }));
          ...
          success: function(res) {
            ...
            if (_.keys(res).length) {
              ...
              annotation.getDepiction = function() {
                var depiction, _ref;
                depiction = (_ref = this.entity['http://xmlns.com/foaf/0.1/depiction']) != null ? _ref["@id"] : void 0;
                return depiction;
              };
