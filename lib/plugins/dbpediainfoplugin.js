      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        jQuery(annotation).bind("becomeActive", function(e) {
          ...
          if (e.annotation.resource.value.indexOf("geonames") < 0) {
            domEl = _this.lime.allocateWidgetSpace("DBPediaInfoPlugin");
            if (domEl) {
              ...
              return e.annotation.widgets.DBPediaInfoPlugin = domEl;
            }
          }
        });
