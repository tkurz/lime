...
(function() {
  ...
  window.LIMEPlayer = (function() {
    ...
    */
    ...
    LIMEPlayer.prototype.filterVisibleWidgets = function(typeArray) {
      ...
      this.options.activeWidgetTypes = typeArrays;
      _ref = this.plugins;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        plugin = _ref[_i];
    ...
    LIMEPlayer.prototype._isWidgetToBeShown = function(widget) {
      ...
      if (this.options.activeWidgetTypes === null) {
        return true;
      }
      return _.contains(this.options.activeWidgetTypes, widget.type);
    };
  ...
  LimeWidget = (function() {
    ...
    function LimeWidget(plugin, element, options) {
      var defMethod, defaults, m, _i, _len, _ref,
        _this = this;
      this.plugin = plugin;
